...
public class AdapterNhanVien extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView imgHinhDaiDien =(ImageView) row.findViewById(R.id.imageView);
        ...
        Bitmap bmHinhDaiDien = BitmapFactory.decodeByteArray(nhanVien.image, 0,nhanVien.image.length);
        ...
        btnXoa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setMessage("Bạn chắc chắn xóa không");
    ...
    private void delete(int idNhanVien) {
        ...
        list.clear();
        database.delete("SinhVien", "ID = ?", new String[]{idNhanVien + ""});
        ...
        while (cursor.moveToNext()){
            ...
            list.add(new NhanVien(id,ten,sdt,image));
